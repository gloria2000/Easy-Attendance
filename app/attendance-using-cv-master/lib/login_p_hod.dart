        ...
        child: Container(
          ...
          decoration: const BoxDecoration(
              gradient: LinearGradient(
                  ...
                  colors: [
                    Color.fromARGB(255, 84, 57, 158),
                    Color.fromARGB(255, 127, 77, 146),
                    Color.fromARGB(255, 117, 31, 91),
                  ]
              )
          ),
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(
                height:200,
                width: 300,
                child: LottieBuilder.asset("assets/lottie/hod.json"),
              ),
